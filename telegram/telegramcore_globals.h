...
#define TG_GEOCHATS_GET_LOCATED_CALLBACK \
    TG_CALLBACK_SIGNATURE(GeochatsLocated)
#define TG_GEOCHATS_GET_RECENTS_CALLBACK \
    TG_CALLBACK_SIGNATURE(GeochatsMessages)
#define TG_GEOCHATS_CHECKIN_CALLBACK \
    TG_CALLBACK_SIGNATURE(GeochatsStatedMessage)
#define TG_GEOCHATS_GET_FULL_CHAT_CALLBACK \
    TG_CALLBACK_SIGNATURE(MessagesChatFull)
#define TG_GEOCHATS_EDIT_CHAT_TITLE_CALLBACK \
    TG_CALLBACK_SIGNATURE(GeochatsStatedMessage)
#define TG_GEOCHATS_EDIT_CHAT_PHOTO_CALLBACK \
    TG_CALLBACK_SIGNATURE(GeochatsStatedMessage)
#define TG_GEOCHATS_SEARCH_CALLBACK \
    TG_CALLBACK_SIGNATURE(GeochatsMessages)
#define TG_GEOCHATS_GET_HISTORY_CALLBACK \
    TG_CALLBACK_SIGNATURE(GeochatsMessages)
#define TG_GEOCHATS_SET_TYPING_CALLBACK \
    TG_CALLBACK_SIGNATURE(bool)
#define TG_GEOCHATS_SEND_MESSAGE_CALLBACK \
    TG_CALLBACK_SIGNATURE(GeochatsStatedMessage)
#define TG_GEOCHATS_SEND_MEDIA_CALLBACK \
    TG_CALLBACK_SIGNATURE(GeochatsStatedMessage)
#define TG_GEOCHATS_CREATE_GEO_CHAT_CALLBACK \
    TG_CALLBACK_SIGNATURE(GeochatsStatedMessage)
...
#define TG_MESSAGES_SEND_MESSAGE_CALLBACK \
    TG_CALLBACK_SIGNATURE(MessagesSentMessage)
