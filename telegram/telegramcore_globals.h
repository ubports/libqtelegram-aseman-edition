...
#define TG_AUTH_IMPORT_BOT_AUTHORIZATION_CALLBACK \
    TG_CALLBACK_SIGNATURE(AuthAuthorization)
#define TG_AUTH_RESEND_CODE_CALLBACK \
    TG_CALLBACK_SIGNATURE(AuthSentCode)
#define TG_AUTH_CANCEL_CODE_CALLBACK \
    TG_CALLBACK_SIGNATURE(bool)
...
#define TG_CHANNELS_DELETE_CHANNEL_CALLBACK \
    TG_CALLBACK_SIGNATURE(UpdatesType)
#define TG_CHANNELS_TOGGLE_INVITES_CALLBACK \
    TG_CALLBACK_SIGNATURE(UpdatesType)
#define TG_CHANNELS_EXPORT_MESSAGE_LINK_CALLBACK \
    TG_CALLBACK_SIGNATURE(ExportedMessageLink)
#define TG_CHANNELS_TOGGLE_SIGNATURES_CALLBACK \
    TG_CALLBACK_SIGNATURE(UpdatesType)
#define TG_CHANNELS_UPDATE_PINNED_MESSAGE_CALLBACK \
    TG_CALLBACK_SIGNATURE(UpdatesType)
...
#define TG_CONTACTS_GET_TOP_PEERS_CALLBACK \
    TG_CALLBACK_SIGNATURE(ContactsTopPeers)
#define TG_CONTACTS_RESET_TOP_PEER_RATING_CALLBACK \
    TG_CALLBACK_SIGNATURE(bool)
...
#define TG_MESSAGES_SEND_INLINE_BOT_RESULT_CALLBACK \
    TG_CALLBACK_SIGNATURE(UpdatesType)
#define TG_MESSAGES_HIDE_REPORT_SPAM_CALLBACK \
    TG_CALLBACK_SIGNATURE(bool)
#define TG_MESSAGES_GET_PEER_SETTINGS_CALLBACK \
    TG_CALLBACK_SIGNATURE(PeerSettings)
#define TG_MESSAGES_GET_MESSAGE_EDIT_DATA_CALLBACK \
    TG_CALLBACK_SIGNATURE(MessagesMessageEditData)
#define TG_MESSAGES_EDIT_MESSAGE_CALLBACK \
    TG_CALLBACK_SIGNATURE(UpdatesType)
#define TG_MESSAGES_EDIT_INLINE_BOT_MESSAGE_CALLBACK \
    TG_CALLBACK_SIGNATURE(bool)
#define TG_MESSAGES_GET_BOT_CALLBACK_ANSWER_CALLBACK \
    TG_CALLBACK_SIGNATURE(MessagesBotCallbackAnswer)
#define TG_MESSAGES_SET_BOT_CALLBACK_ANSWER_CALLBACK \
    TG_CALLBACK_SIGNATURE(bool)
#define TG_MESSAGES_GET_PEER_DIALOGS_CALLBACK \
    TG_CALLBACK_SIGNATURE(MessagesPeerDialogs)
#define TG_MESSAGES_SAVE_DRAFT_CALLBACK \
    TG_CALLBACK_SIGNATURE(bool)
#define TG_MESSAGES_GET_ALL_DRAFTS_CALLBACK \
    TG_CALLBACK_SIGNATURE(UpdatesType)
