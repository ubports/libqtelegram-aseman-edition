...
inline DecryptedMessageActionObject::DecryptedMessageActionObject(const DecryptedMessageAction &core, QObject *parent) :
...
inline DecryptedMessageActionObject::DecryptedMessageActionObject(QObject *parent) :
    TelegramTypeQObject(parent),
    m_action(0),
    m_core()
{
...
inline DecryptedMessageActionObject::~DecryptedMessageActionObject() {
}

inline void DecryptedMessageActionObject::setAction(SendMessageActionObject* action) {
...
inline SendMessageActionObject*  DecryptedMessageActionObject::action() const {
    return m_action;
}

inline void DecryptedMessageActionObject::setEndSeqNo(qint32 endSeqNo) {
...
inline qint32 DecryptedMessageActionObject::endSeqNo() const {
    return m_core.endSeqNo();
}

inline void DecryptedMessageActionObject::setExchangeId(qint64 exchangeId) {
...
inline qint64 DecryptedMessageActionObject::exchangeId() const {
    return m_core.exchangeId();
}

inline void DecryptedMessageActionObject::setGA(const QByteArray &gA) {
...
inline QByteArray DecryptedMessageActionObject::gA() const {
    return m_core.gA();
}

inline void DecryptedMessageActionObject::setGB(const QByteArray &gB) {
...
inline QByteArray DecryptedMessageActionObject::gB() const {
    return m_core.gB();
}

inline void DecryptedMessageActionObject::setKeyFingerprint(qint64 keyFingerprint) {
...
inline qint64 DecryptedMessageActionObject::keyFingerprint() const {
    return m_core.keyFingerprint();
}

inline void DecryptedMessageActionObject::setLayer(qint32 layer) {
...
inline qint32 DecryptedMessageActionObject::layer() const {
    return m_core.layer();
}

inline void DecryptedMessageActionObject::setRandomIds(const QList<qint64> &randomIds) {
...
inline QList<qint64> DecryptedMessageActionObject::randomIds() const {
    return m_core.randomIds();
}

inline void DecryptedMessageActionObject::setStartSeqNo(qint32 startSeqNo) {
...
inline qint32 DecryptedMessageActionObject::startSeqNo() const {
    return m_core.startSeqNo();
}

inline void DecryptedMessageActionObject::setTtlSeconds(qint32 ttlSeconds) {
...
inline qint32 DecryptedMessageActionObject::ttlSeconds() const {
    return m_core.ttlSeconds();
}

inline DecryptedMessageActionObject &DecryptedMessageActionObject::operator =(const DecryptedMessageAction &b) {
...
inline bool DecryptedMessageActionObject::operator ==(const DecryptedMessageAction &b) const {
    return m_core == b;
}

inline void DecryptedMessageActionObject::setClassType(quint32 classType) {
...
inline quint32 DecryptedMessageActionObject::classType() const {
    int result;
...
inline void DecryptedMessageActionObject::setCore(const DecryptedMessageAction &core) {
    operator =(core);
}

inline DecryptedMessageAction DecryptedMessageActionObject::core() const {
    return m_core;
}

inline void DecryptedMessageActionObject::coreActionChanged() {
